...
class ContactRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'phone1.numeric' => '電話番号は半角英数字で入力してください',
            'phone1.digits_between' => '電話番号は５桁まで数字で入力してください',
            'phone2.required' => '電話番号を入力してください',
            'phone2.numeric' => '電話番号は半角英数字で入力してください',
            'phone2.digits_between' => '電話番号は５桁まで数字で入力してください',
            'phone3.required' => '電話番号を入力してください',
            'phone3.numeric' => '電話番号は半角英数字で入力してください',
            'phone3.digits_between' => '電話番号は５桁まで数字で入力してください',
